<div class="dialog" id="delete_dialog">
    <div class="dialog-content">
        <div class="dialog-header">
            <span class="dialog-title">Delete Appointment</span>
        ...
        <div class="dialog-body doctor_dialog">
            <form action="../../includes/delete_appointment.php" method="POST" role="form">
                <div class="form-group my-1">
                    <p class="delete_warning"> Are you sure you want to delete Appointment. Please note this action can not be undone.</p>
                </div>
                <div class="form-group my-1 d-none">
                    <label for="doctor_id" class="my-1">Appointment ID:</label>
                    <input type="hidden" class="form-control" id="appointmentInput" name="appointment_id" value="">
                </div>
