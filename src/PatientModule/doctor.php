...
<html lang="en">
    ...
    <body>
                ...
                <div class="doctors-wrapper">
                    ...
                    <table class="table_listing">
                        ...
                        <tbody>
                            <?php
                                try{
                                    $query="select d.doctor_id,d.name,d.email_address,s.speciality_name
        ...
        <script>
            var appointmentDialog=document.getElementById('appointmentModal');
            
            function showPopupMenu(event){
                event.stopPropagation();

                var showPopupMenu=event.target;
